...
if (isset($id_usr)) {
    ...
    $productos = "SELECT p1.id_prod, p1.nombre_prod, p1.precio_prod, p1.des_prod, p1.fech_prod, p3.telefono, p2.nombre, p3.nombre_pro, p1.img_prod, p1.img_prod_2, p1.img_prod_3
    FROM productos p1 INNER JOIN categoria p2 on p1.id_cat_prod = p2.id_cat_provedor INNER JOIN provedor p3 ON p1.id_provedor = p3.id_provedor";
                        ...
                        <div class="page-title-wrapper">
                            ...
                            <div class="page-title-actions">
                                <div class="d-inline-block dropdown">
                                    ...
                                    aria-expanded="false" class="btn btn-outline-success">Nuevo Producto</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <table class="mb-0 table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                    <a href="TeditarPro.php?id=<?php echo $row["id_prod"]; ?>" type="button" aria-haspopup="true" aria-expanded="false" class="btn btn-outline-primary">Editar
                                                                </a>
                                                    <a href="funciones/elimiar_pro.php?id=<?php echo $row["id_prod"]; ?>" type="button" aria-haspopup="true" aria-expanded="false" class="btn btn-outline-danger" onclick="return confirmar()">Eliminar
                                                                </a>
                                                    </td>
                                                </tr>
