                        ...
                        <div class="page-title-wrapper">
                            ...
                            <div class="page-title-actions">
                                <div class="d-inline-block dropdown">
                                    ...
                                    aria-expanded="false" class="btn btn-outline-success">Nuevo Proveedor</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                 ...
                                                 while ($row = mysqli_fetch_assoc($resultado)) { ?>
                                                    ...
                                                    <td><?php echo utf8_encode($row["nombre_pro"]) ?></td>

                                                    <td><?php echo utf8_encode($row["domicilio"].' '.$row["cp"].' '.$row["localidad"].' '.$row["estadonombre"].' '.$row["paisnombre"])?></td>
                                                  ...
                                                  <td>
                                                    <a href="TeditarP.php?id=<?php echo $row["id_provedor"]; ?>" type="button" aria-haspopup="true" aria-expanded="false" class="btn btn-outline-primary">Editar
                                                                </a>
                                                    <a href="funciones/eliminarP.php?id=<?php echo $row["id_provedor"]; ?>" type="button" aria-haspopup="true" aria-expanded="false" class=" btn btn-outline-danger" onclick="return confirmar()">Eliminar
                                                                </a>
                                                    </td>
                                                </tr>
