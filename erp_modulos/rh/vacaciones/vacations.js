        ...
        const rows = vacationsData.map((data, id) => {
            if (data.employeeId === employeeData.id && data.vacationStatus === "0") {
                return (
                    ...
                    <td>
                    <a href="http://${window.location.hostname}/erp_modulos/rh/vacaciones/format.php?id=${data.id}"><button class="btn btn-sm btn-outline-info" id="btn-view" data=${data.id}  data-tip="tooltip" title="Detalle"><i class="fas fa-eye"></i></button></a>
                    <button class="btn btn-sm btn-outline-primary" id="btn-edit" data-toggle="modal" data-name="${data.employeeLastname.concat(' ', data.employeeMothersLastname, ' ', data.employeeName)}" data-tip="tooltip" title="Editar" data-target="#modal-submit" data=${data.id}><i class="fas fa-edit"></i></button>
                    <button class="btn btn-sm btn-outline-danger" id="btn-delete" data-toggle="modal" data-name="${data.employeeLastname.concat(' ', data.employeeMothersLastname, ' ', data.employeeName)}" data-tip="tooltip" title="Eliminar" data-target="#modal-delete" data=${data.id}><i class="fas fa-trash-alt"></i></button>
                    </td>
                    </tr>`
                )
            }
        ...
        const rows = vacationsData.map((data, id) => {
            if (data.employeeId !== employeeData.id && data.vacationStatus === "0") {
                return (
                    ...
                    <td>
                    <a href="http://${window.location.hostname}/erp_modulos/rh/vacaciones/format.php?id=${data.id}"><button class="btn btn-sm btn-outline-info" id="btn-view" data=${data.id}  data-tip="tooltip" title="Detalle"><i class="fas fa-eye"></i></button></a>
                    <button class="btn btn-sm btn-outline-warning" id="btn-approve" data-name="${data.employeeLastname.concat(' ', data.employeeMothersLastname, ' ', data.employeeName)}" data-tip="tooltip" title="Validar" data=${data.id}><i class="fas fa-thumbs-up"></i> <i class="fas fa-thumbs-down fa-flip-horizontal"></i></button>
                    </td>
                    </tr>`
                )
            }
