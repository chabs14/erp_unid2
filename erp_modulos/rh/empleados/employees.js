        ...
        .then(response => {
            const rows = response.data.map((data, id) => (
                `<tr style="text-align: justify">
                 ...
                 <td data=${data.id}>${data.number}</td>
                 ...
                 <td> 
                 <button class="btn btn-sm btn-outline-primary" id="btn-edit" data-toggle="modal" data-name="${data.name}" data-tip="tooltip" title="Editar" data-target="#modal-edit" data=${data.id}>Editar</i></button>
                 <button class="btn btn-sm btn-outline-danger" id="btn-delete" data-toggle="modal" data-name="${data.name}" data-tip="tooltip" title="Eliminar" data-target="#modal-delete" data=${data.id}>Eliminar</button>
                 </td>
                 </tr>`
            ));
