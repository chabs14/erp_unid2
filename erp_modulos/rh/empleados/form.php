                    ...
                    <div class="page-title-actions">
                        <div class="container">
                            <div class="save" style="width:100%; text-align: right;">
                                <button type="button" id="close" class="btn btn-outline-lg btn-outline-danger">Cerrar</button>
                                <button type="button" id="submit" class="btn btn-outline-lg btn-outline-success">Guardar</button>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="container">
                                        <form id="personalData">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-4">
                                                    <label for="telephone">Telefono (10 dígitos):</label>
                                                    <div class="input-group input-group-sm mb-3">
                                ...
                                <div class="card-body">
                                    <div class="container">
                                        <form id="documentationData">
                                            <div class="form-row">
                                                <div class="form-group col-4">
                                                    <label for="curp">Clave única de registro de población (CURP 18 dígitos):</label>
                                                    <div class="input-group input-group-sm mb-3">
                                                        <input type="text" class="form-control" id="curp" name="curp">
                                                    </div>
                                                </div>
                                                <div class="form-group col-4">
                                                    <label for="nss">Número de seguridad social (NSS 11 dígitos):</label>
                                                    <div class="input-group input-group-sm mb-3">
                                                        <input type="text" class="form-control" id="nss" name="nss">
                                                    </div>
                                                </div>
                                                <div class="form-group col-4">
                                                    <label for="rfc">Reg. Fed. de contribuyentes (RFC 13 dígitos):</label>
                                                    <div class="input-group input-group-sm mb-3">
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="row">
                                            <div class="col text-center">
                                                <button type="button" class="btn btn-outline-light" id="addChildren">
                            ...
                            <div id="collapseSix" class="collapse show" data-parent="#accordion">
                                <div class="card-body">
                                    <div class="container">
                                        ...
                                        <div class="row">
                                            <div class="col text-center">
                                                <button type="button" class="btn btn-outline-light" id="addSchool">
                                                    <i class="fas fa-plus"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col text-center">
                                                <button type="button" class="btn btn-outline-light" id="addCurrentStudies">
                                                    <i class="fas fa-plus"></i>
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="container">
                                        <div class="form-row">
                                            <div class="form-group col" style="padding-right: 20px;">
                                                ...
                                                <div class="col text-center">
                                                    <button type="button" class="btn btn-outline-light btn-outline-sm" id="addFunction" style="height: 32px;">
                                                        <i class="fas fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="form-group col" style="padding-right: 20px;">
                                                ...
                                                <div class="col text-center">
                                                    <button type="button" class="btn btn-outline-light btn-outline-sm" id="addSoftware" style="height: 32px;">
                                                        <i class="fas fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="form-group col">
                                                ...
                                                <div class="col text-center" >
                                                    <button type="button" class="btn btn-outline-light btn-outline-sm" id="addlanguage" style="height: 32px;">
                                                        <i class="fas fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                            ...
                            <div id="collapseEight" class="collapse show" data-parent="#accordion">
                                <div class="card-body">
                                    <div class="container">
                                        ...
                                        <div class="col text-center" >
                                            <button type="button" class="btn btn-outline-light btn-outline-sm" id="addPreviousJob" style="height: 32px;">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div id="collapseNine" class="collapse show" data-parent="#accordion">
                                <div class="card-body">
                                    <div class="container">
                                        ...
                                        <div class="col text-center" >
                                            <button type="button" class="btn btn-outline-light btn-outline-sm" id="addReference" style="height: 32px;">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div id="collapseTen" class="collapse show" data-parent="#accordion">
                                <div class="card-body">
                                    <div class="container">
                                        ...
                                        <div class="col text-center" >
                                            <button type="button" class="btn btn-outline-light btn-outline-sm" id="addWorkingRelatives" style="height: 32px;">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div id="collapseEleven" class="collapse show" data-parent="#accordion">
                                <div class="card-body">
                                    <div class="container">
                                        ...
                                        <div class="col text-center" >
                                            <button type="button" class="btn btn-outline-light btn-outline-sm" id="addOtherIncome" style="height: 32px;">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                        </div>
                                    </div>
