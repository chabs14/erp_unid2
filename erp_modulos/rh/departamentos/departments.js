        ...
        .then(response => {
            const rows = response.data.map((data, id) => (
                `<tr>
                 ...
                 <td>
                 <button class="btn btn-sm btn-outline-primary" id="btn-edit" data-toggle="modal" data-target="#modal-edit" data=${data.id}  data-name="${data.name}">Editar</button>
                 <button class="btn btn-sm btn-outline-danger" id="btn-delete" data-toggle="modal" data-target="#modal-delete" data=${data.id} data-name="${data.name}">Eliminar</button>
                 </td>
                 </tr>`
            ));
