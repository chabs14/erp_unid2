...
<head>
    ...
    <title>Categoria de proveedores</title>
                        ...
                        <div class="page-title-wrapper">
                            ...
                            <div class="page-title-actions">
                                <div class="d-inline-block dropdown">
                                    <a href="insertar-categoria.php" aria-haspopup="true" aria-expanded="false" class="btn btn-outline-success">Nueva Categoria</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <table class="mb-0 table">
                                            ...
                                            <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="tabla-editar.php?id=<?php echo $row["id_cat_provedor"]; ?>" type="button" aria-haspopup="true" aria-expanded="false" class="btn btn-outline-primary">Editar
                                                                </a>
                                                            <a href="funciones/eliminar.php?id=<?php echo $row["id_cat_provedor"]; ?>" type="button" aria-haspopup="true" aria-expanded="false" class="btn btn-outline-danger" onclick="return confirmar()">Eliminar
                                                                </a>
                                                        </td>
                                                    </tr>
